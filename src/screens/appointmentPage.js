...
const procedures_desktop = [
  { id: 1, name: "Gellak (incl. Manicure)", url: "https://calendly.com/contact-nailsbycarlijn/gellak-incl-manicure?hide_event_type_details=0&hide_gdpr_banner=1&primary_color=a8815b" },
  { id: 2, name: "Gellak Verwijderen", url: "https://calendly.com/contact-nailsbycarlijn/gellak-verwijderen?hide_event_type_details=0&hide_gdpr_banner=1&primary_color=a8815b" }, 
  { id: 3, name: "Gellak Verwijderen & Aanbrengen (Incl. Manicure)", url: "https://calendly.com/contact-nailsbycarlijn/gellak-verwijderen-aanbrengen-incl-manicure?hide_event_type_details=0&hide_gdpr_banner=1&primary_color=a8815b" },
  { id: 4, name: "Gellak met Nail Art (incl. Manicure)", url: "https://calendly.com/contact-nailsbycarlijn/gellak-nailairt?hide_event_type_details=0&hide_gdpr_banner=1&primary_color=a8815b" },
  { id: 5, name: "Gellak Verwijderen & Aanbrengen met Nail Art (incl. Manicure)", url: "https://calendly.com/contact-nailsbycarlijn/gellak-verwijderen-zetten-met-art-incl-manicure?hide_event_type_details=0&hide_gdpr_banner=1&primary_color=a8815b" },
  { id: 6, name: "Gellak met French Manicure", url: "https://calendly.com/contact-nailsbycarlijn/french-manicure?hide_event_type_details=0&hide_gdpr_banner=1&primary_color=a8815b" },
  { id: 7, name: "BIAB (Incl. Manicure)", url: "https://calendly.com/contact-nailsbycarlijn/biab-incl-manicure?hide_event_type_details=0&hide_gdpr_banner=1&primary_color=a8815b" },
  { id: 8, name: "BIAB Verwijderen", url: "https://calendly.com/contact-nailsbycarlijn/biab-verwijderen?hide_event_type_details=0&hide_gdpr_banner=1&primary_color=a8815b" },
  { id: 9, name: "BIAB Verwijderen & Aanbrengen (Incl. Manicure)", url: "https://calendly.com/contact-nailsbycarlijn/biab-verwijderen-aanbrengen-incl-manicure?hide_event_type_details=0&hide_gdpr_banner=1&primary_color=a8815b" },
  { id: 10, name: "BIAB Overlay + Gellak (Incl. Manicure)", url: "https://calendly.com/contact-nailsbycarlijn/biab-overlay-incl-manicure?hide_event_type_details=0&hide_gdpr_banner=1&primary_color=a8815b" },
];
  ...
  return (
    <div>
      ...
      <div style={{ position: "relative", marginBottom: "20px" }}>
        ...
        >
          {selectedProcedure
            ? procedures_desktop.find((proc) => proc.id === selectedProcedure).name
            : "Kies een procedure..."}
        </button>
        ...
        {dropdownOpen && (
          ...
          >
            {procedures_desktop.map((procedure) => (
              <li
                key={procedure.id}
      ...
      {selectedProcedure && (
        <div
          ...
          data-url={procedures_desktop.find((proc) => proc.id === selectedProcedure).url}
